...
UPDATE public.photo p SET food_id=(SELECT id FROM public.food WHERE photo_id=p.id);
UPDATE public.photo p SET food_id=(SELECT id FROM public.food WHERE photo_group_id=p.group_id AND parent_id IS NULL);
